...
class Fifty extends Component{
    render(){
        return(
            ...
            <div className="container socialmedia" id='contact'>
      	  				...
      	  				<a href="https://github.com/heshamalamam73"><i className="fa fa-github"></i></a> 
      	  	</div>
            ...
            <p>
            This site is designed by the owner && All rights reserved
            </p>
            </div>
